source('/data4/lbl/Yale/HCL/SAME/SAME/run_same.R')
source('/data4/lbl/Yale/HCL/SAME/SAME/ComBat.R')

NSCLC_seur <- readRDS("Bayesian/CibersortX/Fig2ab-NSCLC_PBMCs/NSCLC_seur.rds")
...
saveRDS(NSCLC_seur, file = "Bayesian/CibersortX/Fig2ab-NSCLC_PBMCs/NSCLC_seur.rds")
...
PBMC_seur <- readRDS("protein_coding/PBMC_ImmuneCell_updated.rds")
Lung_seur <- readRDS("protein_coding/Lung_ImmuneCell_updated.rds")
...
ggbiplot(pca_rst, obs.scale = 1, var.scale = 1,
  ...
  theme_bw()+ ggtitle("Before adjustment")
